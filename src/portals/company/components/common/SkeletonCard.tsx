// src/portals/company/components/common/SkeletonCard.tsx
// Reusable skeleton loader components for all DSA portal pages.
...
export const QueryError: React.FC<{ message?: string; onRetry?: () => void }> = ({
