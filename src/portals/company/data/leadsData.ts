// src/portals/company/data/leadsData.ts
// Aligned with schema_v2.md — Module 03 (DSA), Module 08 (Customer/LoanApplication), Module 13 (Lead/Proposal)

export type LeadStatus = 'PENDING' | 'ASSIGNED' | 'PROPOSAL_SENT' | 'CONFIRMED' | 'REJECTED' | 'CLOSED'
export type LoanType = 'HOME' | 'PERSONAL' | 'BUSINESS' | 'VEHICLE' | 'EDUCATION' | 'LAP' | 'GOLD'
...
export const INITIAL_TEAM_AGENTS: TeamAgent[] = [
  {
    ...
    activeLeadsCount: 2,
    conversionRate: 75,
    avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuD47XHW6F8te6Yjq14-mTqQcQMMNccwR2LiNJT2_F1KUHAN0DqAhIzoJxVdyLzi7OLJaqq4jo8OeikLsUMT-OwTTAD_GE5fuXXLhxiKocVQxSmEV0h7-watC6n0nR54Pt2_-lDfEms80xVWUu0MsIDKtvXElXdlLLoHn1LoQVl9IY_oolxR6HDo-THZzlPiv-YEit1Ni4G6ODCmCNVsCrDr5KaZAbDJdJrYh13bPMg98vzUETgC6QzY',
    isTopPerformer: true,
  ...
  },
  {
    ...
    activeLeadsCount: 3,
    conversionRate: 77,
    avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCagJFwfjkvkUurBaUPUUA62zdKMpf7zq7q4TLLxrP8EfW1MwDHIIFTdiSTIglmRgWLQd_cDevSfWJy7Qaemm-LyUAHgEP5FM-xprBrZ9fo09qtEbMXnziKLsyqNweGJNIwXXkVXB3_Ix0VNHXOumSmPbW1z1TNSmsPSKjvk6Z5biShtjay3cyhkL6I9XZLpKjXQmvxb85C8B64awa8KUw7wsrT6ro73dOTrI0SDidqoJUPvSbZfnT7',
  ...
  },
  {
    ...
    activeLeadsCount: 1,
    conversionRate: 62,
    avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuALYHIq-iEli6ZJEhZeIQMy7--tEUuaaL8rjEZeT9Bt5kFhucUKJsQIxNuPllNCXlmXF8ST6djNm_TM6FO9p0oj7tapRlntQNHyWS6-MULsjrRWp-sd0eNND6FvOseo2s-JI_w1yG8x4yxHTyd57zGcYuckfNf1xlTqv2CXMuxwR_bHbcw1uNl7Y0o0g68Bzleo-cnbjD1sUbXDcasC2es6GGslM4RcO6jFpo8AubjwNTwy-qX4D6i9',
...
export const INITIAL_LEADS: Lead[] = [
  {
    ...
    cibilScore: 780,
    existingEmi: 8000,
    customerNote: 'Looking at a ₹60L property in Whitefield, Bangalore. I have documents ready.',
    internalNotes: 'Strong profile. SBI or HDFC should work. Assigning to Priya — she has best SBI success rate.',
    status: 'PENDING',
    ...
    timeline: [
      {
        ...
        type: 'INFO',
        description: 'Customer filled proposal request for ₹48,00,000 SBI Home Loan.',
      },
    ],
  },
  {
    ...
    cibilScore: 745,
    existingEmi: 5000,
    customerNote: 'Need loan for house renovation and travel. Urgent sanction requested.',
    internalNotes: 'Documents verified. Anoop is following up with customer for salary slips.',
    status: 'ASSIGNED',
    fieldAgentId: 'ag-2',
    ...
    timeline: [
      {
        ...
        type: 'ASSIGNMENT',
        description: 'DSA Manager assigned lead based on Personal Loan conversion rank.',
      },
      {
        id: 'evt-2-2',
        title: 'Lead received from portal',
        ...
        type: 'INFO',
        description: 'Customer filled proposal request for ₹12,00,000 HDFC Personal Loan.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    internalNotes: 'High-value lead. Needs quick turnaround. Assigned to Sneha.',
